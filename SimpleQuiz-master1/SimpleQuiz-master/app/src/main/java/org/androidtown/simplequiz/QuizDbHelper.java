...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillCategoriesTable() {
        Category c1 = new Category("TMI");
        insertCategory(c1);
        Category c2 = new Category("Nonsense");
        insertCategory(c2);
    }
    ...
    private void fillQuestionsTable() {
        Question q1 = new Question("Programming, Easy: A is correct",
                "A", "B", "C", 1,
                Question.DIFFICULTY_EASY, Category.TMI);
        insertQuestion(q1);
        Question q2 = new Question("Geography, Medium: B is correct",
                "A", "B", "C", 2,
                Question.DIFFICULTY_MEDIUM, Category.Nonsense);
        insertQuestion(q2);
        Question q3 = new Question("Math, Hard: C is correct",
                "A", "B", "C", 3,
                Question.DIFFICULTY_HARD, Category.TMI);
        insertQuestion(q3);
        Question q4 = new Question("Math, Easy: A is correct",
                "A", "B", "C", 1,
                Question.DIFFICULTY_EASY, Category.Nonsense);
        insertQuestion(q4);
